...
<div class="container" style="margin-top: 10px">
    <div class="d-inline-block mt-3">
        <button type="button" class="btn btn-blue btn-lg view_product2" value="Consumable" id="view_product">Consumable</button>
    </div>
    <div class="d-inline-block">
        <button type="button" class="btn btn-blue btn-lg view_product2" value="Non-Consumable" id="view_product">Non-Consumable</button>
    </div>
    <div class="d-inline-block">
        <button type="button" class="btn btn-blue btn-lg view_product2" value="E-Load Regular" id="view_product">E-Load Regular</button>
    </div>
    <div class="d-inline-block">
        <button type="button" class="btn btn-blue btn-lg view_product2" value="E-Load Promo" id="view_product">E-Load Promo</button>
    </div>
