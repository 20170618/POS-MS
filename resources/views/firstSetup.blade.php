    ...
    <body>
        <div class="container-fluid " style="height: 100vh">
            ...
            <div class="row col-6 d-flex align-items-center" >
                    ...
                    <h6 class="text-muted">Welcome to the POS-MS<br>
                                            As the first user, you are the admin.<br>
                                            Please register to start using the system.
                    </h6>
                    </div>
                            ...
                            <div class="row yellow">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="firstname" class="form-label mt-4">{{ __('Firstname') }}</label>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                    <label for="lastname" class="form-label mt-4">{{ __('Lastname') }}</label>
