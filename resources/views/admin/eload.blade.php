...
@section('content')
                ...
                <div class="flex-fill card" style="margin:2%">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <button type="button" class="mt-4 btn btn-outline-primary smartRefill">Refill Load</button>
                        </div>
                    </div>
                </div>
                <div class="flex-fill card" style="margin:2%">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <button type="button" class="mt-4 btn btn-outline-primary globeRefill">Refill Load</button>
                        </div>
                    </div>
                </div>
    ...
    <!-- Refill Modal -->
    <div id="refillLoadModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header blue-bg yellow">
                    <h5 class="modal-title" id="refillLoadTitle">Refill Load for</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="inputLoadWallet" class="form-label mt-2">Input Refill Amount:</label>
                        <input type="number" class="form-control" id="inputLoadWallet" aria-describedby="LoadWalletHelp">
                        <small id="LoadWalletHelp" class="form-text text-muted">Minimum load refill is 6000.</small>
                    </div>
                ...
                <div class="modal-footer" style="text-align: right">
                    <button class="btn btn-yellow refill_load" type="button">Refill</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#selectedPromo').on('change', function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/admin/eload/getPromoPrice/" + prodId,
                    dataType: "json",
                    success: function(response) {
